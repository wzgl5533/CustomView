package cn.qlh.sdk.myview.radiobutton;
 ...
 * 1、使用与RadioGroup一样，MutilRadioGroup里的所有RadioButton
 * （包括MutilRadioGroup里嵌套的子布局里面的所有RadioButton）属于同一组。
 * 2、增加方法setCheckWithoutNotif(int id)，设置默认的RadioButton被选中，但是不响应监听事件。
 * 参考资料：https://github.com/pheng/android_radiogroup_MutilRadioGroup
 * */
