 ...
 * 上下拉会回弹的ScrollView
 */
public class DragScrollView extends FrameLayout implements OnTouchListener {
     ...
     *                  to go one page up or {@link View#FOCUS_DOWN} to go one page
     *                  down
     ...
     *
     * @param direction the scroll direction: {@link View#FOCUS_UP}
     *                  to go the top of the view or {@link View#FOCUS_DOWN} to go
     *                  the bottom
     * @return true if the key event is consumed by this method, false otherwise
     */
