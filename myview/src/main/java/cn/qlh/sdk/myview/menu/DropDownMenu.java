package cn.qlh.sdk.myview.menu;
...
public class DropDownMenu extends LinearLayout {
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        tabView.setLayoutParams(new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams
                .WRAP_CONTENT,1.0f));
        ...
        lp.rightMargin = (int) getResources().getDimension(R.dimen.x15);
        tabText.setLayoutParams(lp);

        tabImg.setImageResource(menuUnselectedIcon);
        tabImg.setLayoutParams(new LinearLayout.LayoutParams((int)(getResources().getDimension(R.dimen
                .x24)),(int) (getResources().getDimension(R.dimen
                .x15))));
