...
public class LoadingView extends FrameLayout {
    ...
    public void setLoadingTextColor(String loadingTextColor){
        ...
        if (TextUtils.isEmpty(loadingTextColor)) {
            mLoadTextView.setTextColor(Color.WHITE);
        } else {
            mLoadTextView.setTextColor(Color.parseColor(loadingTextColor));
        }
    }

    public void setLoadingTextSize(int unit,int size){

        mLoadTextView.setTextSize(unit,size);
    }
